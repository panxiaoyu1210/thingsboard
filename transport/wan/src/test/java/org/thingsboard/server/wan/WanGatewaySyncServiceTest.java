...
class WanGatewaySyncServiceTest {
    ...
    private WanGatewaySyncService syncService;
    ...
    void setUp() {
        ...
        syncService = new WanGatewaySyncService(
                registryClient, connectionManager, requestClient, new WanGatewayCommandFactory());
