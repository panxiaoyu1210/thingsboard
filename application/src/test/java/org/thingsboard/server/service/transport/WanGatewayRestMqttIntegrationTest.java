...
import org.thingsboard.server.wan.WanGatewaySyncService;
import org.thingsboard.server.wan.WanGatewaySyncTrigger;
...
public class WanGatewayRestMqttIntegrationTest extends AbstractControllerTest {
    ...
    public void createsGatewayThroughRestAndSynchronizesItThroughMqtt() throws Exception {
        ...
        try {
            ...
            WanGatewaySyncService syncService = new WanGatewaySyncService(registryClient, connectionManager,
                    new WanNsRequestClient(connectionManager, correlator), new WanGatewayCommandFactory());
            new WanGatewaySyncTrigger(syncService).onDeviceUpdated(new DeviceUpdatedEvent(device));
